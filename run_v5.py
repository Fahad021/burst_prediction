...
if __name__ == "__main__":
    ...
    for fid, id_ in enumerate(pid_list):
        ...
        t_data_r = get_samples_for_refine(sys.argv[4], sys.argv[5], sys.argv[6], fid) # [seqs]
        ...
        if os.path.exists("model/id" + str(fid) + "/clf.pkl") and \
           ...
           os.path.exists("model/id" + str(fid) + "/scores.npz"):
            ...
            final_score.append([max(l) for l in scores])
        ...
        final_msq.append(overall_msq)
        print "overall msq: ", overall_msq
